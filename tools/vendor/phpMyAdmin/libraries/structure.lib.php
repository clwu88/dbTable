...
function PMA_getServerSlaveStatus($server_slave_status, $truename)
{
    $ignored = false;
    $do = false;
    include_once __DIR__.'/replication.inc.php';
...
function PMA_displayHtmlForColumnChange($db, $table, $selected, $action)
{
     ...
     */
    include __DIR__.'/tbl_columns_definition_form.inc.php';
}
 ...
 * @return void
 */
function PMA_moveColumns($db, $table, $columnsFull)
{
    /*
...
function PMA_displayTableBrowseForSelectedColumns($db, $table, $goto,
    ...
    include_once __DIR__.'/parse_analyze.inc.php';

    include_once __DIR__.'/sql.lib.php';
...
function PMA_possiblyShowCreateTableDialog($db, $db_is_system_schema, $response)
{
    if (empty($db_is_system_schema)) {
        ob_start();
        include __DIR__.'/display_create_table.lib.php';
