 ...
 */
require_once __DIR__.'/string.lib.php';
    ...
    if ($GLOBALS['is_ajax_request']) {
        ...
        if (!function_exists('__')) {
            ...
            if (defined(GETTEXT_INC)) {
                ...
                include_once __DIR__.'/php-gettext/gettext.inc';
            }
        }
...
function PMA_sendHeaderLocation($uri, $use_refresh = false)
{
    if (PMA_IS_IIS && /*overload*/mb_strlen($uri) > 600) {
        include_once __DIR__.'/js_escape.lib.php';
...
function PMA_linkURL($url)
{
    ...
    if (!function_exists('PMA_URL_getCommon')) {
        include_once __DIR__.'/url_generating.lib.php';
    }
    $params = array();
    $params['url'] = $url;
